...
The optics are scaled down to match the box:
...
With [Checkbox](/docs/components/checkbox) and
[Radio](/docs/components/radio-group) now flat, this is one of the smallest
surfaces the lens is still asked to render, and it is a good place to check a
global `refractionScale` you have pushed up.
